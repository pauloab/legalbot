...
from etl.pdf_utils import load_pdf, get_text_by_page
import os
import traceback
from io import BytesIO

from etl.document_storage import DocumentStorage, Document
...
def send_chat_message(
    ...
    try:
        ...
        chatbot = Chatbot(memory, model, temperature, memory.context)
