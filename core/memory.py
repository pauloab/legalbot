class Memmory:
    ...
    def __init__(
        ...
        self.__human_prefix = human_prefix
        self.__chatbot_prefix = chatbot_prefix
    ...
    def add_human_message(self, message):
        self.__update_history(self.__human_prefix + ": " + message)

    def add_chatbot_message(self, message):
        self.__update_history(self.__chatbot_prefix + ": " + message)
    ...
    def get_history_prompt(self):
        ...
        prompt = self.__memory_prompt.format(
            ...
            history=messages,
            human_prefix=self.__human_prefix,
            chatbot_prefix=self.__chatbot_prefix,
        )
        return prompt
